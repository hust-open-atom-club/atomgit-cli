...
## Purpose
Define remote branch management behavior for AtomGit CLI, including listing, viewing, creating, and safely deleting AtomGit repository branches without modifying local Git branches.
