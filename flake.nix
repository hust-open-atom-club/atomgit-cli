{
  ...
  inputs.nixpkgs.url = "git+https://mirror.nju.edu.cn/git/nixpkgs.git?ref=nixos-unstable&shallow=1";
  inputs.nixpkgs-darwin.url = "git+https://mirror.nju.edu.cn/git/nixpkgs.git?ref=nixpkgs-26.05-darwin&shallow=1";
