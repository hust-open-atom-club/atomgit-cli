...
import (
	...
	"atomgit.com/hust-open-atom-club/atomgit-cli/pkg/cmd/update"
	"atomgit.com/hust-open-atom-club/atomgit-cli/pkg/cmd/user"
...
func newCmdRootWithWriters(f *cmdutil.Factory, stdout, stderr io.Writer) (*cobra.Command, error) {
	...
	cmd.AddCommand(kanban.NewCmdKanban(f))
